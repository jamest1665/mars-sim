...
/**
 * @file campaign.hpp
 * @brief Campaign Simulator - long-term mission planning engine.
 *
 * Supports multi-year colony growth, dynamic agent decisions,
 * Earth supply events, and rolling reliability tracking.
 */
